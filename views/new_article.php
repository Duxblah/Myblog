...
<div class="form_container">
	<form action="?p=do_article" method="POST" name="form_article" enctype="multipart/form-data">
			...
			<?php if (isset($_POST['err_file'])) { echo '<span class="error">' . $_POST['err_file'] . '</span>'; } ?>		
		<p>
			<label>Contenu</label>
